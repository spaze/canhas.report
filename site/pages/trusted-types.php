...
<div class="content">
	...
	<p><em>
		With Trusted Types enabled, when a plain string is passed to a so-called sink like the <code>innerHTML</code> or the <code>document.write()</code> method without it being escaped by the Trusted Types policy, a report is generated by the browser.
		Because the policy is enforced, the string will not actually be passed to the sink, protecting your app against <abbr title="Document Object Model">DOM</abbr>-based cross-site scripting (<abbr title="Cross-Site Scripting">XSS</abbr>) attacks.
	</em></p>
	...
	<p>
		...
		<code class="allowed">#html</code> sink: <code id="html">&hellip;</code> / <code class="blocked">#xss</code> sink: <code id="xss">&hellip;</code>
	...
	<ul>
		<li>Is <span class="allowed">allowed</span> in a way that it will display the HTML you've entered, escaped</li>
		<li>
			Uses the <code>createHTML()</code> method of the <code>escapePolicy</code> created by <code>trustedTypes.createPolicy()</code>
			<ul>
		...
		<li>
			If you enter let's say <code>&lt;em&gt;</code>
			<ul>
	...
	The <code class="blocked">#xss</code> sink:
	<ul>
		<li>Is <span class="allowed">blocked</span>, the HTML you've entered will not be passed to the <code>innerHTML</code> property</li>
		<li>Because it doesn't use the <code>createHTML()</code> method of the <code>escapePolicy</code></li>
		<li>But it tries to pass a plain string which is forbidden with Trusted Types enabled</li>
